...
--
-- 資料表結構 `willow_cart_orders`
--

CREATE TABLE `willow_cart_orders` (
  `sid` int(11) NOT NULL,
...
--
-- 傾印資料表的資料 `willow_cart_orders`
--

INSERT INTO `willow_cart_orders` (`sid`, `member_sid`, `created_at`, `total_quantity`, `pay_price`, `pay_type`, `store_name`, `market_name`, `ship_name`, `ship_phone`, `ship_email`, `ship_address`, `discount_code`) VALUES
